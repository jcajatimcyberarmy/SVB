import urllib2 , cookielib , random , re , sys , socket , time , httplib , ssl
       ...
       ##################################################
       # Author : Mr Tuman                              #
       # Team   : Jatim Cyber Army                      #
       # Date   : Kontol                                #
       # Github : https://github.com/jcajatimcyberarmy  #
       ##################################################
...
if __name__ == "__main__":
	print ("      "+Y+" =====[ Author : Mr Tuman ]==== ")
	print (R+" |'+'|"+Y+" =====[Team:JatimCyberTeam]==== ")
	print (R+" (o o)"+Y+" =====[Yt..:jatimcybetarmy]==== ")
	print (R+"  (_) "+Y+" =====[.  Fb.. MrTuman    ]===="+W+" Fakk")
	print (W+43*"-")
